 ...
 <h3>A Non-satirical Guide</h3>
  ...
  <br>
  <br>
  1. Install dotnet (version 10.x as of 26.04 LTS).<br>
  # apt install dotnet10<br>
  2. Install wine64<br>
  # apt install wine64<br>
  3. Install Powershell<br> 
  ...
  4. Install ADsys and related components (Ask your work IT for assistance, this could get tricky!!)<br>
